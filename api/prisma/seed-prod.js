...
async function main() {
  ...
  if (!adminEmail || !adminPassword) {
    console.error(
      '❌ ADMIN_EMAIL et ADMIN_PASSWORD doivent être définis (variables d\'environnement) '
      + 'pour lancer le seed de production. Exemple :\n'
  ...
  if (adminPassword.length < 12) {
    console.error('❌ ADMIN_PASSWORD doit contenir au moins 12 caractères (même règle qu\'à l\'inscription).');
    process.exit(1);
  }
